...
//                   <img src={guest.img} alt="card figure" className="card-figure glass-bg-01" style={{ borderRadius: "50%" }} />
//                 </div>
      ...
      <div className="card-container" ref={cardContainerRef}>
        {guests.map((guest, index) => (
          <ScrollAnimation>
            ...
            <div key={index} className="card">
              {/* <div className="card-body bg-transparent rounded-lg border-b-white border-r-white border-b border-r"> */}
              <div className="card-body bg-transparent rounded-lg ">
                <div className="card-images">
