        ...
        <div className=" flex flex-col md:flex-row items-center justify-center">
          ...
          <div className=" lg:py-10">
            <p className="text-gray-300 mx-6 text-lg lg:text-xl lg:mx-16 lg:pl-10">
              ...
              century who had the courage to think out of the box. Vishwapreneur
              is a platform for budding entrepreneurs to seek motivation &
              guidance through the experiences of successful business tycoons.
            </p>
          </div>
        </div>
      </div>
